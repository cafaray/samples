...
@NamedQueries({
    ...
    @NamedQuery(name = "Inventario.findByCveProd", query = "SELECT i FROM Inventario i WHERE i.cveProd = :cveProd"),
    @NamedQuery(name = "Inventario.findByCamplib1", query = "SELECT i FROM Inventario i WHERE i.camplib1 = :camplib1"),
    @NamedQuery(name = "Inventario.findByCamplib2", query = "SELECT i FROM Inventario i WHERE i.camplib2 = :camplib2"),
    @NamedQuery(name = "Inventario.findByCamplib3", query = "SELECT i FROM Inventario i WHERE i.camplib3 = :camplib3"),
    @NamedQuery(name = "Inventario.findByCamplib4", query = "SELECT i FROM Inventario i WHERE i.camplib4 = :camplib4"),
    @NamedQuery(name = "Inventario.findByCamplib5", query = "SELECT i FROM Inventario i WHERE i.camplib5 = :camplib5"),
    @NamedQuery(name = "Inventario.findByCamplib6", query = "SELECT i FROM Inventario i WHERE i.camplib6 = :camplib6"),
    @NamedQuery(name = "Inventario.findByCamplib7", query = "SELECT i FROM Inventario i WHERE i.camplib7 = :camplib7")})
public class Inventario implements Serializable {
    ...
    public Inventario(String cveProd) {
